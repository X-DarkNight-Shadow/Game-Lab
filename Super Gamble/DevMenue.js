...
function Def(){
    ...
    document.getElementById("Valid-run").innerHTML = "&#9432; Invalid" ;
    document.getElementById("Valid-run").style.color = "red";
    document.getElementById("Valid-run").style.textShadow = "0px 0px 5px red";
